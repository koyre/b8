...
forst : FOR id ASSIGN expr DDOT expr block
         { $$ = new ForNode($2 as IdentNode, $4 as ExprNode, $6 as ExprNode, $7 as BlockNode); }
	  ;


whilest : WHILE expr block{ $$ = new WhileNode($2 as ExprNode, $3); }
        ;
 
ifst :  IF expr block { $$ = new IfNode($2 as ExprNode, $3); }
       |  IF expr block ELSE block { $$ = new IfNode($2 as ExprNode, $3, $5); }
     ;
